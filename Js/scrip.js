const form = document.getElementById('anemiaForm');
        ...
        function showResults(yesCount) {
            ...
            // Botón para ir a precauciones.html
            let extraBtn = `<button class="reset-btn" style="margin-left:10px;display:inline-block;text-align:center;" onclick="window.location.href='precauciones.html'">Ver Precauciones</button>`;
